...
export class InitialSchema1787988354424 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "idx_users_email_active" ON "users" ("email") WHERE "deleted_at" IS NULL`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."products_status_enum" AS ENUM('draft', 'pending_review', 'published', 'out_of_stock', 'archived')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "idx_products_slug" ON "products" ("slug") WHERE "deleted_at" IS NULL`);
        ...
        await queryRunner.query(`CREATE TABLE "wishlist_items" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "wishlist_id" uuid NOT NULL, "product_id" uuid NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_0bd52924a97cda208ed2a07bd69" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "idx_wishlist_items_unique" ON "wishlist_items" ("wishlist_id", "product_id") `);
        await queryRunner.query(`CREATE TABLE "wishlists" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "REL_b5e6331a1a7d61c25d7a25cab8" UNIQUE ("user_id"), CONSTRAINT "PK_d0a37f2848c5d268d315325f359" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE INDEX "idx_order_items_seller" ON "order_items" ("seller_id") `);
        await queryRunner.query(`CREATE INDEX "idx_order_items_order" ON "order_items" ("order_id") `);
        await queryRunner.query(`CREATE TYPE "public"."order_status_history_previous_status_enum" AS ENUM('pending_payment', 'payment_submitted', 'paid', 'processing', 'ready', 'shipped', 'delivered', 'cancelled', 'rejected')`);
        await queryRunner.query(`CREATE TYPE "public"."order_status_history_new_status_enum" AS ENUM('pending_payment', 'payment_submitted', 'paid', 'processing', 'ready', 'shipped', 'delivered', 'cancelled', 'rejected')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."orders_status_enum" AS ENUM('pending_payment', 'payment_submitted', 'paid', 'processing', 'ready', 'shipped', 'delivered', 'cancelled', 'rejected')`);
        await queryRunner.query(`CREATE TYPE "public"."orders_shipping_method_enum" AS ENUM('standard', 'express', 'pickup')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "idx_orders_number" ON "orders" ("order_number") `);
        await queryRunner.query(`CREATE INDEX "idx_orders_status" ON "orders" ("status") `);
        await queryRunner.query(`CREATE INDEX "idx_orders_user" ON "orders" ("user_id") `);
        await queryRunner.query(`CREATE TYPE "public"."payments_provider_enum" AS ENUM('mvola', 'orange_money', 'airtel_money')`);
        await queryRunner.query(`CREATE TYPE "public"."payments_status_enum" AS ENUM('pending', 'submitted', 'verified', 'rejected', 'refunded')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "idx_payments_reference_active" ON "payments" ("provider", "transaction_reference") WHERE "status" IN ('pending','submitted','verified')`);
        await queryRunner.query(`CREATE INDEX "idx_payments_status" ON "payments" ("status") `);
        await queryRunner.query(`CREATE INDEX "idx_payments_order" ON "payments" ("order_id") `);
        await queryRunner.query(`CREATE TYPE "public"."notifications_type_enum" AS ENUM('ORDER_CREATED', 'ORDER_PAID', 'ORDER_STATUS_CHANGED', 'PAYMENT_SUBMITTED', 'PAYMENT_VERIFIED', 'PAYMENT_REJECTED', 'SELLER_APPLICATION_RECEIVED', 'SELLER_APPROVED', 'SELLER_REJECTED', 'SELLER_SUSPENDED', 'LOW_STOCK')`);
        ...
        await queryRunner.query(`CREATE INDEX "idx_notifications_read" ON "notifications" ("user_id", "read_at") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "idx_idempotency_unique" ON "idempotency_keys" ("scope", "key") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "idx_cart_items_cart_product" ON "cart_items" ("cart_id", "product_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "products" ADD CONSTRAINT "FK_425ee27c69d6b8adc5d6475dcfe" FOREIGN KEY ("seller_id") REFERENCES "sellers"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "order_items" ADD CONSTRAINT "FK_fd9d07d1f1457c1147418d6cbc4" FOREIGN KEY ("seller_id") REFERENCES "sellers"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "payments" ADD CONSTRAINT "FK_fc2beb4403c1d6267b003e0889c" FOREIGN KEY ("verified_by") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "payments" DROP CONSTRAINT "FK_fc2beb4403c1d6267b003e0889c"`);
        ...
        await queryRunner.query(`ALTER TABLE "order_items" DROP CONSTRAINT "FK_fd9d07d1f1457c1147418d6cbc4"`);
